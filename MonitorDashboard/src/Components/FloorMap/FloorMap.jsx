...
const FloorMap = () => {
  ...
  const handleMouseEnter = (event, dataInfo) => {
    setInfo(dataInfo);
    setShowTooltip(true);
  };
    ...
    >
      ...
      >
        <path
          ...
          strokeWidth="12"
          id="walkway"
          onMouseEnter={(e) => handleMouseEnter(e, "walkway")}
        ...
        >
          <title id="walkwayTitle">Walkway</title>
        </path>
        <path
          fill="#7F8C8D"
          opacity="1"
          ...
          strokeLinejoin="round"
          strokeWidth="12"
          onMouseEnter={(e) => handleMouseEnter(e, "Robotic Observatory")}
          onMouseMove={handleMouseMove}
          onMouseLeave={handleMouseLeave}
          ...
          id="robotic"
        >
          <title id="roboticTitle">Robotic Observatory</title>
        </path>
        <path
          fill="#7F8C8D"
          opacity="1"
          ...
          strokeLinejoin="round"
          strokeWidth="12"
          onMouseEnter={(e) => handleMouseEnter(e, "This is the green hub")}
          onMouseMove={handleMouseMove}
          onMouseLeave={handleMouseLeave}
          ...
          id="hub"
        >
          <title id="greenHubTitle">Green Hub</title>
        </path>
        <path
          fill="#7F8C8D"
          opacity="1"
          ...
          id="dome"
          onMouseEnter={(e) => handleMouseEnter(e, "This is the dom")}
          onMouseMove={handleMouseMove}
          onMouseLeave={handleMouseLeave}
        >
          <title id="domeTitle">Science Dome</title>
        </path>
        <path
          fill="#7F8C8D"
          opacity="1"
          ...
          strokeLinejoin="round"
          strokeWidth="12"
          onMouseEnter={(e) => handleMouseEnter(e, "This is the RAMM")}
          onMouseMove={handleMouseMove}
          onMouseLeave={handleMouseLeave}
        ...
        <path
          ...
          id="musk"
          onMouseEnter={(e) =>
            handleMouseEnter(e, "This is the musk observatory")
          }
          onMouseMove={handleMouseMove}
          onMouseLeave={handleMouseLeave}
        >
          <title id="muskTitle">Musk Observatory</title>
        </path>
        <path
          fill="#7F8C8D"
          opacity="1"
          ...
          strokeLinejoin="round"
          strokeWidth="12"
          onMouseEnter={(e) => handleMouseEnter(e, "This is the main base")}
          onMouseMove={handleMouseMove}
          onMouseLeave={handleMouseLeave}
          id="mainBase"
        ...
        >
          <title id="mainBaseTitle">Main Base</title>
        </path>
      </svg>
      <div
        style={{
